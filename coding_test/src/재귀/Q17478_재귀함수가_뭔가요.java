...
public class Q17478_재귀함수가_뭔가요 {
	static String division_line = "";
	public static void main(String[] args) {
		Scanner sc = new Scanner(System.in);
		int N = sc.nextInt();
		String basic = "어느 한 컴퓨터공학과 학생이 유명한 교수님을 찾아가 물었다.";
		System.out.println(basic);
		repeatFunc(N);
	}
	public static void repeatFunc(int N) {
		String line = division_line;
		if(N == 0) {
